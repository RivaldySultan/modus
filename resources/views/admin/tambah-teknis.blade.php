...
<body class="flex h-screen overflow-hidden text-gray-800">
            ...
            <nav class="mt-6 flex flex-col gap-2 px-4">
                ...
                <div class="flex flex-col">
                    ...
                    <div id="submenuDataMaster" class="hidden flex-col pl-12 pr-3 py-2 space-y-4 transition-all duration-300">
                        <a href="/data-teknis" class="sidebar-text text-[13px] flex items-center gap-2 whitespace-nowrap transition-colors text-[#2a93c9] font-semibold nav-active-indicator">
                        ...
                        <a href="/data-jenis-sk" class="sidebar-text text-[13px] text-gray-700 hover:text-[#2a93c9] flex items-center gap-2 whitespace-nowrap transition-colors">
        ...
        <div class="px-8 pt-2 pb-10">
            ...
            <div class="flex justify-center w-full mt-4">
                <div class="bg-[#f8fafc] border border-gray-200 shadow-sm p-10 rounded-sm w-[450px]">
                    ...
                    <form id="formTambahTeknis">
                        <div class="mb-5">
                            <label class="block text-[#4a9bc8] text-[13px] mb-2 font-medium">Kelompok Bagian</label>
                            <div class="relative">
                                <select id="input-kelompok" class="w-full border border-[#4a9bc8] rounded h-[40px] px-3 text-[#4a9bc8] text-[13px] outline-none appearance-none bg-white cursor-pointer" required>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="input-nama" class="w-full border border-[#4a9bc8] rounded h-[40px] px-3 text-gray-700 outline-none focus:ring-1 focus:ring-[#4a9bc8] bg-white" required>
                        </div>

                        <div class="mb-8">
                            <label class="block text-[#4a9bc8] text-[13px] mb-2 font-medium">Kode Teknis/Administrasi</label>
                            <input type="text" id="input-kode" class="w-full border border-[#4a9bc8] rounded h-[40px] px-3 text-gray-700 outline-none focus:ring-1 focus:ring-[#4a9bc8] bg-white" required>
                        </div>
    ...
    <script>
        ...
        // SCRIPT SUBMIT FORM KE LOKAL STORAGE
        document.getElementById('formTambahTeknis').addEventListener('submit', function(e) {
            e.preventDefault(); 

            // Ambil value dari input
            const kelompokVal = document.getElementById('input-kelompok').value;
            const namaVal = document.getElementById('input-nama').value;
            const kodeVal = document.getElementById('input-kode').value;

            // Ambil data yang sudah ada di localStorage, jika kosong jadikan array []
            let dataTeknis = JSON.parse(localStorage.getItem('dummyTeknis')) || [];
            ...
            localStorage.setItem('dummyTeknis', JSON.stringify(dataTeknis));

            // Kembalikan user ke halaman tabel Data Teknis
            window.location.href = '/data-teknis';
        });
    </script>
<script>
(function(){
